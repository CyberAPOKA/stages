...
@section('title', 'Consultar Processos')

@section('content-title', 'Consulta de processos seletivos')
    ...
    <div class="col-md-12">
        <div class="card card-fullscreen shadow p-3 mb-5 bg-white rounded">
            <div class="card-header row">
                <h4 class="card-title" id="bordered-layout-colored-controls"> <strong>Informações do candidato</strong>
                </h4>
            </div>
            ...
            <div class="card-content collpase show card-body">
                ...
                <div class="text-center" style="margin-top: 50px;">
                    ...
                    <a href="{{route('voltar')}}" class="custom-button btn btn-primary">Voltar</a>
